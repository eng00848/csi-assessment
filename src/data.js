...
export const QUESTIONS = [
  ["I am good at generating new ideas.", "I am good at building upon existing ideas."],
  ["I become bored easily with routine tasks.", "I can perform long detailed tasks without boredom."],
  ["I am good with details.", "I can see the big picture."],
  ["I value originality.", "I value practicality."],
  ["I prefer to follow the book.", "I prefer to make it up as I go along."],
  ["I like to try out new and untried solutions.", "I like to try practical solutions."],
  ["I prefer to work on one project at a time.", "I prefer to work on several projects simultaneously."],
  ["I produce many ideas, some of which may be unworkable.", "I produce a few relevant and proven ideas."],
  ["I believe policies should be challenged.", "I believe policies should be followed."],
  ["I promote harmony in groups.", "I promote the sharing of different opinions in groups."],
  ["I seek familiarity.", "I seek adventure."],
  ["I complete projects in a roundabout way.", "I complete projects in a step-by-step fashion."],
  ["I like doing things in a familiar way.", "I like doing things differently each time."],
  ["I like to hand off a project once I know it can be done.", "I like to follow a project through to the end."],
  ["I prefer creating something new.", "I prefer improving upon something that already exists."],
  ["I appreciate tradition.", "I appreciate change."],
  ["I like working on cutting-edge issues.", "I like working on relevant day-to-day issues."],
  ["I make decisions based on actual fact.", "I make decisions based on my intuition."],
  ["I prefer written instructions.", "I prefer picture instructions."],
  ["I respond to situations in a measured way.", "I respond to situations spontaneously."],
]
